...
interface ModalErrorFormatoProps {
  onClose: () => void;
}

export default function ModalErrorFormato({ onClose }: ModalErrorFormatoProps) {
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-[380px] p-6 relative">
        ...
        <p className="text-[#16469B] text-sm mb-6">
          El número de expediente debe contener solo dígitos válidos.
        </p>
